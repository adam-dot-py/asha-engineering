...
def transform_dbo_support_notes_data(bronze_schema, gold_schema, bronze_table_name, gold_table_name, con, **kwargs):
    """
    """
...
if __name__ == "__main__":
    ...
    gold_schema = 'gold'
    bronze_table_name = 'dbo_support_notes'
    gold_table_name = 'fact__support_notes'
