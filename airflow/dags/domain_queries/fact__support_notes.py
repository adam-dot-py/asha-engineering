...
@log_execution
def transform_dbo_support_notes_data(host, user, root_pass, base_table_name, domain_table_name, **kwargs):
    """
    """
    ...
    mdf = pd.melt(
        df,
        id_vars=["SupportProviders", "SuccessfulSubmission", "Success%"],
        var_name="Cycle",
        value_name="Value",
    )
...
if __name__ == "__main__":
    ...
    transform_dbo_support_notes_data(host=host, user=user, root_pass=root_pass, base_table_name=base_table_name, domain_table_name=domain_table_name)