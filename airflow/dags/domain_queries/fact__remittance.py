...
@log_execution
def transform_dbo_remittance_data(host, user, root_pass, base_table_name, domain_table_name, **kwargs):
    """
    """
...
if __name__ == "__main__":
    ...
    transform_dbo_remittance_data(host=host, user=user, root_pass=root_pass, base_table_name=base_table_name, domain_table_name=domain_table_name)