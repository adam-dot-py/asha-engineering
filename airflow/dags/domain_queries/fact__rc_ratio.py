...
@log_execution
def transform_dbo_rc_ratio_data(host, user, root_pass, base_table_name, domain_table_name, **kwargs):
    """
    """
...
if __name__ == "__main__":
    ...
    user = "root"
    root_pass = "admin"
    base_table_name = 'dbo_rc_ratio_data'
    domain_table_name = 'fact__rc_data'

    transform_dbo_rc_ratio_data(host=host, user=user, root_pass=root_pass, base_table_name=base_table_name, domain_table_name=domain_table_name)