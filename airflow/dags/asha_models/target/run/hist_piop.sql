      ...
      update "asha_dev"."history"."hist_piop" as DBT_INTERNAL_TARGET
    set dbt_valid_to = DBT_INTERNAL_SOURCE.dbt_valid_to
    from "hist_piop__dbt_tmp_3b24d170_abcd_426b_bf59_46c1009a90e3" as DBT_INTERNAL_SOURCE
    ...
    insert into "asha_dev"."history"."hist_piop" ("cycle", "paid_remittances", "received_remittances", "percentage_differences", "ingested_at_ts", "source_file", "dbt_updated_at", "dbt_valid_from", "dbt_valid_to", "dbt_scd_id")
