      ...
      update "asha_dev"."history"."hist_leavers" as DBT_INTERNAL_TARGET
    set dbt_valid_to = DBT_INTERNAL_SOURCE.dbt_valid_to
    from "hist_leavers__dbt_tmp_2bda6610_b477_459f_9f6f_467b597a5ff4" as DBT_INTERNAL_SOURCE
    ...
    insert into "asha_dev"."history"."hist_leavers" ("sr_no", "tenant_name", "crn", "leaving_address", "ninumber", "dob", "vacate_date", "date_informed", "notes", "ingested_at_ts", "source_file", "dbt_updated_at", "dbt_valid_from", "dbt_valid_to", "dbt_scd_id")
