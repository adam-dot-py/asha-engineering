    ...
    create  table
      "asha_prod"."main_silver"."std_tsm_sea_responses__dbt_tmp"
    ...
    'TSM SEA Survey' AS SurveySource,
    CONCAT(id, '-tsm-sea') AS IDSK

FROM "asha_prod"."main_staging"."stg_tsm_sea_responses"
    );
