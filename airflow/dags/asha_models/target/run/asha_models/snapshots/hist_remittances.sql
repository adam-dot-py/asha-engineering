    ...
    from "hist_remittances__dbt_tmp20260622140044490793" as DBT_INTERNAL_SOURCE
    ...
    insert into "asha_prod"."history"."hist_remittances" ("support_provider_id", "support_providers", "cycle", "value", "ingested_at_ts", "source_file", "dbt_updated_at", "dbt_valid_from", "dbt_valid_to", "dbt_scd_id")
