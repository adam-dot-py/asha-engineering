    ...
    from "hist_property_submissions__dbt_tmp20260506190035194892" as DBT_INTERNAL_SOURCE
    ...
    insert into "asha_prod"."history"."hist_property_submissions" ("sr_no", "property_address", "units", "support_providers", "submission_date", "ingested_at_ts", "source_file", "dbt_updated_at", "dbt_valid_from", "dbt_valid_to", "dbt_scd_id")
