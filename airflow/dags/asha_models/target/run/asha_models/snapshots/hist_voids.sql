      ...
      update "asha_prod"."history"."hist_voids" as DBT_INTERNAL_TARGET
    set dbt_valid_to = DBT_INTERNAL_SOURCE.dbt_valid_to
    from "hist_voids__dbt_tmp20260506190036617384" as DBT_INTERNAL_SOURCE
    ...
    insert into "asha_prod"."history"."hist_voids" ("support_provider_id", "support_providers", "cycle", "value", "ingested_at_ts", "source_file", "dbt_updated_at", "dbt_valid_from", "dbt_valid_to", "dbt_scd_id")
