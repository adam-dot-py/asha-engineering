    ...
    from "hist_properties_sp_dal__dbt_tmp20260506190034851014" as DBT_INTERNAL_SOURCE
    ...
    insert into "asha_prod"."history"."hist_properties_sp_dal" ("id", "support_providers", "property_address", "number_of_units", "is_the_landlord_same_as_company_director?_(yes_or_no)", "ingested_at_ts", "source_file", "dbt_updated_at", "dbt_valid_from", "dbt_valid_to", "dbt_scd_id")
