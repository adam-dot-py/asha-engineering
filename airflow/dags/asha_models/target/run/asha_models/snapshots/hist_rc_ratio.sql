    ...
    from "hist_rc_ratio__dbt_tmp20260817110055042166" as DBT_INTERNAL_SOURCE
    ...
    insert into "asha_prod"."history"."hist_rc_ratio" ("support_provider_id", "support_providers", "cycle", "value", "ingested_at_ts", "source_file", "dbt_updated_at", "dbt_valid_from", "dbt_valid_to", "dbt_scd_id")
