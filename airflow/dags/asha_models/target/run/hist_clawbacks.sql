      ...
      update "asha_dev"."history"."hist_clawbacks" as DBT_INTERNAL_TARGET
    set dbt_valid_to = DBT_INTERNAL_SOURCE.dbt_valid_to
    from "hist_clawbacks__dbt_tmp_efedbc88_959f_4121_b77a_eb4680441fb5" as DBT_INTERNAL_SOURCE
    ...
    insert into "asha_dev"."history"."hist_clawbacks" ("support_provider_id", "support_providers", "cycle", "value", "ingested_at_ts", "source_file", "dbt_updated_at", "dbt_valid_from", "dbt_valid_to", "dbt_scd_id")
