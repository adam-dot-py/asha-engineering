{{config(
  post_hook="COPY {{ this }} TO '/home/asha/airflow/dags/gold/semantic/gold_hqi.parquet' (FORMAT PARQUET)"
)}}
...
SELECT
  ...
  a.inspection_month as InspectionMonth,
  a.NumberofUnitsCovered,
  a.NumberofHousingQualityIssuesIdentifiedDuringInspection,
  a.HighPriority,
  a.LowPriority,
  a.NonEmergencyOther,
  a.NumberofHousingQualityIssuesResolvedwithinGivenTimeFramePct,
  a.ingested_at_ts,
  a.source_file,
  a.dbt_scd_id,
  a.dbt_updated_at,
