...
@log_execution
def extract_dbo_dal_summary_data(host, user, root_pass, db_name, table_name, target_source_path: str, target_sheet: str, **kwargs):
    """
    """
...
if __name__ == "__main__":
    ...
    extract_dbo_dal_summary_data(host=host, user=user, root_pass=root_pass, db_name=db_name, table_name=table_name, target_source_path=target_source_path, target_sheet=target_sheet)