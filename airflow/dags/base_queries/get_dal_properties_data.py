...
@log_execution
def extract_dbo_dal_properties_data(token, schema, table_name, target_source_path: str, target_sheet: str, **kwargs):
    """
    """
                ...
                with pd.ExcelFile(file_path) as xls:
                    for sheet in xls.sheet_names:
                        if sheet == target_sheet:
                            ...
                            df['PropertyAddress'] = df['PropertyAddress'].str.upper() # 123 UPPER ROAD
...
if __name__ == "__main__":
    ...
    extract_dbo_dal_properties_data(token=token, schema=schema, table_name=table_name, target_source_path=target_source_path, target_sheet=target_sheet)