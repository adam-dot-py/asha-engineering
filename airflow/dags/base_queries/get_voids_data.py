...
@log_execution
def extract_dbo_voids_data(host, user, root_pass, db_name, table_name, target_source_path: str, target_sheet: str, **kwargs):
    """
    """
                    ...
                    for sheet in xls.sheet_names:
                        if sheet == target_sheet:
                            ...
                            for col in df.columns:
                                if col not in ['SupportProviders', 'Units']:
...
if __name__ == "__main__":
    ...
    extract_dbo_voids_data(host=host, user=user, root_pass=root_pass, db_name=db_name, table_name=table_name, target_source_path=target_source_path, target_sheet=target_sheet)