...
def extract_lease_database(target_source_path: str, target_sheet: str, table_name: str,  **kwargs):
    ...
    for root, dirs, files in os.walk(target_source_path):
        for file in files:
            if file == "PBI DATA - Copy.xlsx":
                ...
                new_columns = [tidy_columns(col).lower() for col in polarsDF.columns]
